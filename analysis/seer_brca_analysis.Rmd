---
title: "SEER data analysis for breast cancer cases"
...
## New metastasis-Free Survival in TN (3 year months censoring)
...
```{r mfs-tn-dist-survival_rate_at_3y, fig.width=2.5, fig.asp=0.8}
plot_data <- use_data %>% 
