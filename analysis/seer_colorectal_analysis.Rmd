---
title: "SEER data analysis for colon and rectum cancer cases"
...
#Selected site names
primary_sites <- grep('colon|rectum', unique(data_met_dx$site_recode_icd_o_3_who_2008), value = TRUE, ignore.case = TRUE)
```
