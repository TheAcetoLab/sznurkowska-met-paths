site_palette <- c(
  liver = 'firebrick', lung = 'blue', `primary_tumor`  = 'grey55', `bone`  = '#FFBD4C',
  Liver = 'firebrick', Lung = 'blue', `Primary tumor`  = 'grey55', `Bone`  = '#FFBD4C'
  )

site_palette_2 <- c(
  liver = "#D55E00", lung = "#0072B2", `primary_tumor`  = 'grey55',
  Liver = "#D55E00", Lung = "#0072B2", `Primary tumor`  = 'grey55'
)

celltype_palette <- c(
  Macrophages = "#009E73",
  `Endothelial cells` = "#E69F00",
  Monocytes = "#D55E00",
  Neutrophils = "#F0E442",
  DC = "#56B4E9",
  Fibroblasts = "#CC79A7",
  `B cells, pro`= '#9EDAE5',
  `Epithelial cells` = "#898989",
  Basophils ="#B10318"
)

scale_color_viridis_log10scaled <- scale_colour_gradientn(
  colors = viridisLite::viridis(
    10, alpha = 1, begin = 0, end = 1, direction = 1, option = "D"
  ),
...
site_type_palette <- c(
  liver_normal = "#D55E00", lung_normal = "#A2C8EC",
  `Liver Normal` = "#D55E00", `Lung Normal` = "#A2C8EC",
  liver_tme = "firebrick", lung_tme = "blue",
  `Liver TME` = "firebrick", `Lung TME` = "blue"
)
